...
class ViewModel {
    ...
    func loadProject() {
        projects = [
            Project(description: "Designed and developed an e-commerce application tailored for the Mumbai market, similar to Amazon and Flipkart.", name: "FAIRPICK", applogo: "Fairpick", techUsed: ["UIKit", "AVFoundation", "Firebase", "Razorpay", "Push Notification"], images: ["fairpick1", "fairpick2", "fairpick3", "fairpick4", "fairpick5", "fairpick6"], link: []),
